...
<%
	...
	String order=(String)request.getAttribute("o");
%>
		...
		<div class="row mg15">
			...
			<div class="seven columns maincol" id="posts">
				...
				<%}else{
					...
					<a style="color:#fff" class="" href="/main?o=year&page=<%=pgifo.getCurrentPageNo()%>">按发行时间排序</a>
					</div>
					<%
				...
				<div class="">
					<script>
					  ...
					  PageClick = function(pageclickednumber) {
							location="/main?o=<%=order%>&page="+pageclickednumber;
						}
					</script>
					<div id="pager" ></div>
				</div>
